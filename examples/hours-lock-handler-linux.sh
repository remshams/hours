#!/bin/bash
# hours-lock-handler-linux.sh
# Example script for Linux using dbus to monitor screen lock events (GNOME)
#
# This script monitors GNOME ScreenSaver signals to detect lock/unlock events.
#
# Setup:
#   1. Edit the SSH_HOST variable to point to your hours server
#   2. Make this script executable: chmod +x hours-lock-handler-linux.sh
